/*
    Client-side admin menu action: set absolute bonus skill points for self.
*/
...
[player, player, _amount, _reason] remoteExecCall ["RPG_fnc_setAdminSkillPoints", 2, false];
